...
var Weapons = []WeaponDef{
	{0, "Glock-18", 20, 3.0, 450, .36, 1.2, .12, 1.0, .58, 30, 180, 1400, false, 1},
	{1, "Desert Eagle", 41, 2.3, 267, .22, 2.2, .36, .98, .93, 11, 53, 1800, false, 1},
	{2, "MP5-SD", 22, 3.0, 800, .50, 1.45, .06, 1.0, .65, 45, 180, 1800, true, 1},
	{3, "AK-47", 28, 4.0, 600, .38, 2.0, .17, .92, .78, 45, 135, 2200, true, 1},
	{4, "M4A4", 26, 3.6, 666, .28, 1.65, .11, .93, .70, 45, 135, 2100, true, 1},
	{5, "AWP", 92, 2.5, 32, .03, 4.8, 0, .76, .98, 8, 45, 2800, false, 1},
	{6, "Knife", 34, 1, 150, 0, 0, 0, 1.08, 1, 0, 0, 0, false, 1},
	{7, "USP-S", 23, 2.4, 352, .16, 1.4, .22, 1.0, .50, 18, 36, 1700, false, 1},
	{8, "UMP-45", 22, 2.6, 600, .68, 1.55, .10, .97, .63, 38, 150, 2100, true, 1},
	{9, "FAMAS", 26, 3.2, 700, .36, 1.75, .14, .94, .67, 38, 135, 2200, true, 1},
	{10, "AUG", 26, 3.4, 600, .27, 1.6, .12, .88, .70, 45, 135, 2300, true, 1},
	{11, "SSG 08", 68, 2.4, 40, .05, 3.8, 0, .80, .82, 12, 120, 2600, false, 1},
	{12, "XM1014", 12, 1.2, 150, 3.2, 4.2, .40, .93, .62, 8, 36, 2600, false, 6},
}
